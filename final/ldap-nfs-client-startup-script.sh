...
nslcd nslcd/ldap-uris string ldap://testingldap
...
ldap-auth-config ldap-auth-config/ldapns/ldap-server string ldap://testingldap/
...
sed -i 's,uri ldapi:///,uri ldap://testingldap/,g' /etc/ldap.conf
